...
<Info>
  **🧠 Stateful Conversations:** Every webhook includes `recentHistory` (configurable 0-50 messages, default 10) and `conversationState` (your custom metadata) — giving your AI agent full context without extra API calls.
</Info>
